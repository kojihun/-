...
const fallbackSlideImages = [
  ...
  "https://images.unsplash.com/photo-1712848419861-1ecf0d0a9faf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxrb3JlYW4lMjBjaHVyY2glMjB3b3JzaGlwJTIwc2VydmljZXxlbnwxfHx8fDE3NzM1NjQyNjl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  "https://images.unsplash.com/photo-1769837230054-7f3a7356dde1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21tdW5pdHklMjB2b2x1bnRlZXIlMjBzZXJ2aWNlJTIwb3V0ZG9vcnxlbnwxfHx8fDE3NzM1NjQyNjl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  "https://images.unsplash.com/photo-1655472355485-d949925e67bb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx5b3VuZyUyMGFkdWx0cyUyMGJpYmxlJTIwc3R1ZHklMjBncm91cHxlbnwxfHx8fDE3NzM1NjQyNzB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  "https://images.unsplash.com/photo-1664627297293-baff5469bdab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxqZWp1JTIwaXNsYW5kJTIwbmF0dXJlJTIwbGFuZHNjYXBlfGVufDF8fHx8MTc3MzU2NDI3MHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  "https://images.unsplash.com/photo-1575344995367-1d9b70cd8515?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjaHVyY2glMjBmZWxsb3dzaGlwJTIwbWVhbCUyMHRvZ2V0aGVyfGVufDF8fHx8MTc3MzU2NDI3MXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
];

/** 프로젝트 스토어에서 최신순 이미지를 가져오는 헬퍼 */
function getSlideImages(): string[] {
  const projects = getProjects();
  // visible 프로젝트만, 최신순(연도 내림차순) 이미지 추출
  const images = projects
    .filter((p) => p.visible && p.image)
    .map((p) => p.image);
  return images.length > 0 ? images : fallbackSlideImages;
}
